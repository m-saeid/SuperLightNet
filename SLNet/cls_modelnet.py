...
# ************************************* GlobalContextBiSSM ************************************
from encoder.global_context_bissm import GlobalContextBiSSM
# ************************************* GlobalContextBiSSM ************************************
...
class Classification(nn.Module):
    def __init__(self,
        ...
        self.encoder = Encoder(
            ...
            # ************************************* GlobalContextBiSSM ************************************
            bissm_use=bissm_use,
            bissm_n_layers=bissm_n_layers,
            bissm_dropout=bissm_dropout,
            bissm_use_rezero=bissm_use_rezero,
            bissm_use_gate=bissm_use_gate,
            bissm_use_skip=bissm_use_skip,
            # ************************************* GlobalContextBiSSM ************************************
        )
        ...
        # ************************************* GlobalContextBiSSM ************************************
        self.bissm_use = bissm_use
        if bissm_use:
            self.global_context_BiSSM = GlobalContextBiSSM(dim=last_dim,
                                                        hidden_dim=last_dim//4,
                                                        n_layers=bissm_n_layers, #1,
                                                        dropout=bissm_dropout, #0.1,
                                                        use_rezero=bissm_use_rezero, #True,
                                                        use_gate=bissm_use_gate, #True,
                                                        use_skip=bissm_use_skip, #True)
        )
        # ************************************* GlobalContextBiSSM ************************************
    ...
    def forward(self, xyz, feature):
        ...
        # ************************************* GlobalContextBiSSM ************************************
        # x: global_context_BiSSM input: (batch, N, dim)
        x = self.global_context_BiSSM(f_list[-1].permute(0,2,1)).permute(0,2,1) if self.bissm_use else f_list[-1]
        # ************************************* GlobalContextBiSSM ************************************
...
def parse_args():
    ...
    parser.add_argument('--alpha', type=float, default=1000.0, help='alpha')
    parser.add_argument('--beta', type=float, default=100.0, help='beta')
    ...
    # ************************************* GlobalContextBiSSM ************************************
    parser.add_argument('--bissm_use', type=str, default='yes', help='Global Context BiSSM; bissm_use')
    parser.add_argument('--bissm_n_layers', type=int, default=1, help='Global Context BiSSM; n_layers')
    parser.add_argument('--bissm_dropout', type=float, default=0.1, help='Global Context BiSSM; dropout')
    parser.add_argument('--bissm_use_rezero', type=str, default='yes', help='Global Context BiSSM; use_rezero')
    parser.add_argument('--bissm_use_gate', type=str, default='yes', help='Global Context BiSSM; use_gate')
    parser.add_argument('--bissm_use_skip', type=str, default='yes', help='Global Context BiSSM; use_skip')
    # ************************************* GlobalContextBiSSM ************************************
...
def main():
    ...
    # ************************************* GlobalContextBiSSM ************************************
    args.bissm_use = True if args.bissm_use=='yes' else False
    args.bissm_use_rezero = True if args.bissm_use_rezero=='yes' else False
    args.bissm_use_gate = True if args.bissm_use_gate=='yes' else False
    args.bissm_use_skip = True if args.bissm_use_skip=='yes' else False
    # ************************************* GlobalContextBiSSM ************************************
    ...
    net = Classification(n=args.n,
                         ...
                         # ************************************* GlobalContextBiSSM ************************************
                         bissm_use=args.bissm_use,
                         bissm_n_layers=args.bissm_n_layers,
                         bissm_dropout=args.bissm_dropout,
                         bissm_use_rezero=args.bissm_use_rezero,
                         bissm_use_gate=args.bissm_use_gate,
                         bissm_use_skip=args.bissm_use_skip,
                         # ************************************* GlobalContextBiSSM ************************************
                         )
