...
def download():
    ...
    H5_DIR = "/home/iris/Desktop/Datasets_2080/ScanObjectNN/h5_files/"
...
def load_scanobjectnn_data(partition):
    # download()
    BASE_DIR = "/home/fovea/Desktop/Datasets_3080/ScanObjectNN/h5_files/" #os.path.dirname(os.path.abspath(__file__))
    all_data = []
    all_label = []
