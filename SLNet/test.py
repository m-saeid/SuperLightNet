...
def parse_args():
    ...
    parser.add_argument('-c', '--checkpoint', default='LPTNet_emb16_KL32_KAtt32-20241125033423-5171', type=str, metavar='PATH',
                        help='path to save checkpoint (default: checkpoint)')
    parser.add_argument('--msg', type=str, help='message after checkpoint')
    parser.add_argument('--batch_size', type=int, default=16, help='batch size in training')
    parser.add_argument('--model', default='SLNet_edge0_fps', help='model name [default: SLNet]')
