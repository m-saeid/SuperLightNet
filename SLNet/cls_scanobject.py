...
def parse_args():
    ...
    parser.add_argument('--aug_type', default='translate_pointcloud', type=str, help='aug_type')  # translate_pointcloud
    parser.add_argument('--shuffle_points', default='yes', type=str, help='shuffle_points')

    parser.add_argument('--label_smoothing', default='yes', type=str, help='label_smoothing')
...
def main():
    ...
    args.shuffle_points = True if args.shuffle_points=="yes" else False
    args.label_smoothing = True if args.label_smoothing=="yes" else False
    ...
    train_loader = DataLoader(ScanObjectNN(partition='training', num_points=args.n, aug_type=args.aug_type, shuffle_points=args.shuffle_points),
                              num_workers=args.workers,
                              batch_size=args.batch_size, shuffle=True, drop_last=True)
    
    test_loader = DataLoader(ScanObjectNN(partition='test', num_points=args.n, aug_type=args.aug_type, shuffle_points=args.shuffle_points),
                             num_workers=args.workers,
