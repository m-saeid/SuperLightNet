...
N=1024                          # 1024
EMBED_Modelnet='mlp' # ('adaptive' 'gaussian' 'cosine')                # ('gaussian' 'grouped_conv_mlp' 'cosine' 'mlp')   # mlp
EMBED_Scanobject='adaptive'
INITIAL_DIM=3                   # 3
EMBED_DIM=32 # 32 64) # (16 32) # 64)            # 16
ALPHA_BETA='yes_ba'     #('yes_ba' 'yes_ab' 'no')     # 'no')         # no
SIGMA=0.4            # 0.4

RES_DIM_RATIO=0.25
BIAS=false    #####################                  # Flase
USE_XYZ=true  #####################                  # True
NORM_MODE='anchor-yes_ab'       # ('anchor-yes_ba' 'anchor-yes_ab' 'no')         # ('nearest_to_mean' 'anchor' 'center')
...
SEED=(0 42 1234 2025 9999 100 200 400 600 1000 2000 5000)
WORKERS_ModelNet=6
