...
class PartNormalDataset(Dataset):
    def __init__(self, npoints=2500, split='train', normalize=False):
        ...
        # self.root = 'data/data/shapenet/shapenetcore_partanno_segmentation_benchmark_v0_normal'
        self.root = '/home/saeid/Desktop/saeid/datasets/shapenetcore_partanno_segmentation_benchmark_v0_normal/'
