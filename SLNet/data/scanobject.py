...
class ScanObjectNN(Dataset):
    def __init__(self, num_points, partition='training', aug_type='translate_pointcloud', shuffle_points=True):
        self.data, self.label = load_scanobjectnn_data(partition)
        self.num_points = num_points
        self.partition = partition
        self.aug = DataAugmentation(aug_type)
    ...
    def __getitem__(self, item):
        ...
        if self.partition == 'training':
            ...
            pointcloud = self.aug.transform(pointcloud)
