...
def load_data(partition):
    ...
    #DATA_DIR = os.path.join(BASE_DIR, 'data')
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    #if os.path.exists('/home/fovea/Desktop/Datasets_3080/ModelNet40/'):
    #    DATA_DIR = '/home/fovea/Desktop/Datasets_3080/ModelNet40/'
    #elif os.path.exists('/home/iris/Desktop/Datasets_2080/ModelNet40/'):
    #    DATA_DIR = '/home/iris/Desktop/Datasets_2080/ModelNet40/'
    #elif os.path.exists('/home/zeus/Desktop/Datasets_1080/ModelNet40/'):
    #    DATA_DIR = '/home/zeus/Desktop/Datasets_1080/ModelNet40/'
